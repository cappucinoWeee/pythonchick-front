...
const gamesMockData = [
  {
    ...
    description:
      'Embark on a journey through a magical world where you solve Python puzzles to proceed to the next level.',
    ...
    gameData: {
      introduction:
        'Welcome to the Kingdom of Pythonia! The royal castle is under a spell that only Python code can break.',
      scenes: [
        {
          id: 'scene1',
        ...
        },
        {
          ...
          description:
            "You've entered the courtyard. A fountain in the center has strange symbols that match the numbers 1 to 10.",
          challenge: {
            type: 'loop',
        ...
        },
        {
          ...
          description:
            'The garden path is blocked by magical plants that respond only to calculations.',
          challenge: {
            type: 'calculation',
        ...
        },
        {
          ...
          description:
            'You find an old library filled with magical books. A strange puzzle blocks the path forward.',
          challenge: {
            type: 'string',
            instructions:
              "Create a string variable named 'password' with the value 'Pythonista' and print it in all uppercase",
        ...
        },
        {
          ...
          description:
            'The laboratory is filled with potion ingredients. You need to create a potion by mixing ingredients in a specific order.',
          challenge: {
            type: 'list',
            instructions:
              "Create a list of ingredients: 'frog legs', 'dragon scale', 'wizard hair', 'phoenix feather', and 'troll snot'. Then print each item on a separate line.",
            starterCode: '# Create a list of ingredients\n',
            solution:
              "ingredients = ['frog legs', 'dragon scale', 'wizard hair', 'phoenix feather', 'troll snot']\nfor ingredient in ingredients:\n    print(ingredient)",
        ...
        },
        {
          ...
          description:
            "You've reached the top of the wizard's tower. A magical chessboard blocks your path with a logic puzzle.",
          challenge: {
            type: 'conditionals',
            instructions:
              "Write code that checks if a number is divisible by both 3 and 5. If it is, print 'Magic Number'. If not, print 'Ordinary Number'. Test with the number 15.",
        ...
        },
        {
          ...
          description:
            "Finally, you've reached the throne room where the spell source is located. To break it, you must create a powerful function.",
          challenge: {
            type: 'function',
            instructions:
              "Create a function called 'break_spell' that takes a string parameter and returns that string reversed. Call the function with the argument 'Python' and print the result.",
            starterCode: '# Create the break_spell function\n',
            solution:
              "def break_spell(text):\n    return text[::-1]\n\nresult = break_spell('Python')\nprint(result)",
  ...
  },
  {
    ...
    slug: 'code-quest',
    description:
      'Choose your character and embark on a quest to collect coding gems by solving Python challenges.',
      ...
      levels: [
        {
          ...
          description:
            'Navigate through the Forest of Variables, collecting gems as you define and use variables correctly.',
          challenges: [
            {
              id: 'challenge1',
            ...
            },
            {
              ...
              description:
                "Create three variables: 'gem_name' with value 'Ruby', 'gem_count' with value 10, and 'gem_value' with value 15.5",
            ...
            },
            {
              ...
              description:
                "Calculate the total value of the gems by multiplying 'gem_count' (7) by 'gem_value' (12.5)",
              starterCode:
                '# Calculate total value using variables\ngem_count = 7\ngem_value = 12.5\n\n',
              solution:
            ...
            },
            {
              ...
              description:
                "Create a sentence combining the variables 'gem_count' (3) and 'gem_type' ('Emeralds')",
              starterCode:
            ...
            },
            {
              ...
              description:
                'Create a gem collection with red, green, and blue gems. Calculate and print the total.',
        ...
        },
        {
          ...
          description:
            'Explore the mysterious caverns where your path depends on making the right decisions with conditional statements.',
          challenges: [
            {
              id: 'challenge1',
              title: 'Simple If Statement',
              description:
                "Check if the number of gems (8) is greater than 5. If true, print 'You have enough gems!'",
            ...
            },
            {
              ...
              description:
                "Check if the gem type is 'Diamond'. If true, print 'Rare gem!', otherwise print 'Common gem.'",
            ...
            },
            {
              ...
              description:
                "Categorize gems based on count: 0-5 is 'Beginner', 6-15 is 'Collector', above 15 is 'Gem Master'",
  ...
  },
  {
    ...
    description:
      'Build and operate a function factory! Define Python functions to automate various processes in your growing factory.',
      ...
      factoryLevels: [
        {
          ...
          tasks: [
            ...
            },
            {
              ...
              description:
                'Create a function that calculates production capacity based on worker count and hours',
        ...
        },
        {
          ...
          description:
            'Enhance your factory with advanced functions that include parameters and return values',
          tasks: [
            {
              id: 'task1',
            ...
            },
            {
              ...
              description:
                'Create a function that allocates resources efficiently to different production lines',
              starterCode: '# Define the allocate_resources function\n\n',
              solution:
                'def allocate_resources(total_resources, production_lines):\n    return total_resources // production_lines',
              tests: [
                {
            ...
            },
            {
              ...
              description:
                'Create a function that performs multiple quality checks and returns a comprehensive report',
              starterCode: '# Define the advanced_quality_check function\n\n',
              solution:
                "def advanced_quality_check(product, durability, appearance, functionality):\n    total_score = durability + appearance + functionality\n    if total_score >= 25:\n        return 'Premium quality'\n    elif total_score >= 15:\n        return 'Standard quality'\n    else:\n        return 'Below standards'",
              tests: [
                {
  ...
  },
  {
    ...
    slug: 'bug-hunter',
    description:
      'Track down and eliminate bugs in Python code! Use your debugging skills to fix broken code.',
  ...
  },
  {
    ...
    slug: 'data-explorer',
    description:
      'Embark on a data science adventure where you analyze data to discover hidden treasures.',
