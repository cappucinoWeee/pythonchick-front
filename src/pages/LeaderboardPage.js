...
const LeaderboardPage = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      align: 'right',
      render: (xp) => (
        <Text strong>{xp.toLocaleString()} XP</Text>
      ),
    },
    {
      title: 'Action',
      ...
      render: (_, record) => (
        !record.isCurrentUser && (
          <Button 
            type={record.isFriend ? "default" : "primary"} 
            size="small"
          >
      ...
      <div className="bg-white rounded-xl shadow-card mb-6 p-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <Row gutter={[24, 24]} align="middle">
            <Col xs={24} md={12}>
              <div>
                <Title level={2} className="mb-2">Leaderboard</Title>
              ...
              <div className="flex flex-wrap justify-center md:justify-end gap-3">
                <Card className="w-[130px] text-center">
                  <Tooltip title="Your current rank">
                    <Title level={3} className="mb-0 text-blue-500">#{user.rank || 5}</Title>
                ...
                <Card className="w-[130px] text-center">
                  <Tooltip title="Total experience points">
                    <Title level={3} className="mb-0 text-green-500">{user.experience}</Title>
                ...
                <Card className="w-[130px] text-center">
                  <Tooltip title="Your daily streak">
                    <Title level={3} className="mb-0 text-red-500">{user.streak} 🔥</Title>
