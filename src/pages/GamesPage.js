      ...
      <Card className="shadow-md border-0 mb-6">
        <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
          <div>
            ...
            <Text className="text-gray-600">Learn Python through fun interactive games</Text>
          </div>
          ...
          <Col xs={24} md={8}>
            <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.2 }}>
              <Card className="h-full">
                ...
                <Text>
                  Learning through games makes coding enjoyable and keeps you motivated to continue
                  learning.
                </Text>
              </Card>
            </motion.div>
          ...
          <Col xs={24} md={8}>
            <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.2 }}>
              <Card className="h-full">
                ...
                <Text>
                  Games provide real-world context for coding concepts, helping you understand how
                  to apply them.
                </Text>
              </Card>
            </motion.div>
          ...
          <Col xs={24} md={8}>
            <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.2 }}>
              <Card className="h-full">
                ...
                <Text>
                  Earn XP, unlock achievements, and see your coding skills improve as you complete
                  more games.
                </Text>
              </Card>
            </motion.div>
