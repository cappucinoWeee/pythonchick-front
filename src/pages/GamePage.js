...
const GamePage = () => {
  ...
  const gameSteps = [
    ...
    },
    {
      ...
      challenge: 'I start with a P, help you see things, and am used in every Python program. What am I?',
      options: [
        'Python',
        'Program',
        'print()',
  ...
  // Update the progress when current step changes
  useEffect(() => {
  ...
  const handleCheckAnswer = () => {
    ...
    // Check different types of challenges
    if (currentChallenge.type === 'selection' || currentChallenge.type === 'quiz' || currentChallenge.type === 'riddle') {
      isCorrect = parseInt(answer) === currentChallenge.correctAnswer;
    } else if (currentChallenge.type === 'print' || currentChallenge.type === 'variable' || currentChallenge.type === 'math' || currentChallenge.type === 'fill') {
      isCorrect = answer.trim() === currentChallenge.expectedCompletion;
    } else if (currentChallenge.type === 'match') {
      // Match type would need its own logic
  ...
  const renderCharacterSelection = () => (
    <Card className="shadow-md border-0 text-center">
      <Title level={2} className="mb-6 text-primary">Choose your character</Title>
  ...
  // Render Environment Selection Screen
  const renderEnvironmentSelection = () => (
    <Card className="shadow-md border-0 text-center">
      <Title level={2} className="mb-6 text-primary">Choose your playground</Title>
      ...
      <div className="game-container">
        <Card className="shadow-md border-0 mb-4">
          <div className="flex justify-between items-center mb-4">
            <Space>
              ...
              <Text strong>Step {currentStep + 1} of {gameSteps.length}</Text>
            </Space>
            <div>
              <Tooltip title="XP earned">
                <span className="text-yellow-500 font-bold">
                  <StarOutlined className="mr-1" />{xp} XP
                </span>
              </Tooltip>
            </div>
          </div>
        ...
        >
          <div className="bg-white bg-opacity-90 p-6 rounded-lg">
            <Title level={3} className="mb-2">{currentChallenge.title}</Title>
            ...
            <div className="challenge-container p-4 bg-blue-50 border border-blue-100 rounded-lg mb-4">
                ...
                {currentChallenge.type === 'selection' || currentChallenge.type === 'quiz' || currentChallenge.type === 'riddle' ? (
                    <div className="mt-4">
                    ...
                    {/* Matching game would be implemented here */}
            ...
            <div className="hint-container mb-4 p-3 bg-yellow-50 border border-yellow-100 rounded-lg">
                <Text type="warning"><strong>Hint:</strong> {currentChallenge.hint}</Text>
            </div>
            )}
    ...
    const renderCompletion = () => (
        <Card className="shadow-md border-0 text-center py-8">
          ...
          >
            ...
            <Title level={2} className="text-primary mb-4">Adventure Complete!</Title>
