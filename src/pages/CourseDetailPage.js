...
import { HomeOutlined, BookOutlined, ReadOutlined, WarningOutlined } from '@ant-design/icons';
          ...
          const processedCourse = {
            ...
            topics: Array.isArray(data.topics)
              ? data.topics.map((topic) => ({
                  ...
                  id: topic.id,
                  is_locked:
                    topic.is_locked === undefined ? topic.order_index > 0 : topic.is_locked,
      ...
      {isLocked ? (
        <div className="text-center my-12">
          <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-8 max-w-lg mx-auto">
            ...
            <h2 className="text-xl font-medium text-yellow-800 mb-2">Course Locked</h2>
