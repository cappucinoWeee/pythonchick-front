...
import { HomeOutlined, FileTextOutlined, PrinterOutlined, DownloadOutlined, LockOutlined } from '@ant-design/icons';
    ...
    <div className="privacy-policy-page pb-6">
      ...
      <Card className="shadow-md border-0">
        ...
        <Paragraph className="mb-8">
          At Pythonchick, we value your privacy and are committed to protecting your personal information. This Privacy Policy explains what information we collect, how we use it, and the choices you have regarding your data.
        </Paragraph>
        ...
        <div className="text-center mt-8">
          ...
          <Paragraph>
            If you have specific questions about your data privacy, please don't hesitate to contact our Data Protection Officer.
          </Paragraph>
          <Paragraph strong>
