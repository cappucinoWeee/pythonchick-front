...
const CourseHeader = ({ course }) => {
  ...
  const completedLessons = course.topics.reduce(
    (sum, topic) => sum + topic.lessons.filter((lesson) => lesson.completed).length,
    0,
  );
          ...
          <Row gutter={[24, 24]} align="middle" className="mt-2">
            <Col xs={24} md={16}>
              ...
              <Space className="mt-2 mb-4" size="large" wrap>
                ...
                {progressPercentage === 100 ? (
                  ...
                  <Tag color="processing" className="ml-auto">
                    In Progress
                  </Tag>
                ) : (
            ...
            <Col xs={24} md={8}>
              <Card className="border shadow-sm">
                ...
                <Button type="primary" block icon={<RocketOutlined />} size="large">
