    ...
    <AntFooter className="bg-white p-0 mt-auto">
      <div className="container mx-auto px-4 py-6">
        <Row gutter={[24, 24]} className="mb-6">
          <Col xs={24} sm={12} md={8} lg={6}>
            ...
            <p className="text-gray-600">
              Making Python programming fun and accessible for kids through interactive, game-based learning.
            </p>
          </Col>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <Space size="large">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary text-xl">
              <GithubOutlined />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary text-xl">
              <TwitterOutlined />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary text-xl">
              <InstagramOutlined />
            </a>
          </Space>
        </div>
