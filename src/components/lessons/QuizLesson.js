  ...
  questions: [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Python is a high-level programming language that is interpreted, object-oriented, and has dynamic semantics.',
    },
    {
      id: 2,
      ...
      correctAnswer: 2,
      explanation:
        'Python uses indentation to define blocks of code, unlike other programming languages that use curly braces or other symbols.',
    },
    {
      id: 3,
      ...
      correctAnswer: 2,
      explanation:
        'In Python, comments start with the # character and extend to the end of the line.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'The ** operator in Python is used for exponentiation. So 2 ** 3 means 2 raised to the power of 3, which equals 8.',
    },
    {
      id: 5,
      ...
      correctAnswer: 2,
      explanation:
        'Lists are mutable in Python, which means they can be changed after creation. Strings, tuples, and integers are immutable.',
    },
  ],
};
...
const QuizLesson = ({ course, topic, lesson, onComplete, onNextLesson }) => {
  ...
  const [selectedAnswers, setSelectedAnswers] = useState(
    Array(sampleQuiz.questions.length).fill(null),
  );
              ...
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Text className="text-sm font-medium">
                    {Math.round(((currentQuestion + 1) / sampleQuiz.questions.length) * 100)}%
                    Complete
                  </Text>
                </div>
                <Progress
              ...
              >
                <Space direction="vertical" className="w-full">
                  {getCurrentQuestion().options.map((option, index) => (
                    <motion.div key={index} whileHover={!isAnswerSubmitted ? { scale: 1.01 } : {}}>
                      <Radio
                        value={index}
                        className={`
            ...
            <Card className="shadow-md border-0 text-center py-8">
              ...
              >
                ...
                <div className="relative inline-block mb-4">
                  <div className="text-6xl font-bold text-purple-600 relative z-10">
                    {getScore()}%
                  </div>
            ...
            <div className="text-center">
              ...
              <div className="mt-4">
                <Progress
                  type="circle"
                  percent={
                    ((currentQuestion + (isAnswerSubmitted ? 1 : 0)) /
            ...
            <div className="text-center">
              ...
              {isQuizCompleted ? (
                <div className="mt-4">
                  ...
                  <Text className="block">Quiz completed! Great job!</Text>
                </div>
              ) : (
                <div className="mt-4">
                  <Badge count="+20 XP" style={{ backgroundColor: '#D9D9D9' }} className="mb-2" />
                  <Text type="secondary">Complete the quiz to earn XP points</Text>
                </div>
              )}
            </div>
          </Card>
