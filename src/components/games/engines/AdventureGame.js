  ...
  if (scenes.length === 0) {
    return (
      <Card className="text-center py-8">
        ...
        <Paragraph>There appears to be no content for this adventure yet.</Paragraph>
        <Button type="primary" onClick={() => (window.location.href = '/games')}>
          Back to Games
        </Button>
      </Card>
  ...
  if (!scene) {
    return (
      <Card className="text-center py-8">
        ...
        <Paragraph>The requested scene couldn't be loaded.</Paragraph>
        <Button type="primary" onClick={() => (window.location.href = '/games')}>
          Back to Games
        </Button>
      </Card>
        ...
        {scene.challenge && (
          <>
            ...
            <div className="mt-4 flex justify-between">
              ...
              {currentScene > 0 && (
                <Button onClick={() => setCurrentScene(currentScene - 1)}>Previous Scene</Button>
              )}
            </div>
          </>
        )}
