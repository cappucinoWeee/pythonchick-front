          ...
          {characters.map((char) => (
            <Col xs={24} sm={8} key={char.id}>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                ...
                >
                  <Avatar src={char.avatar} size={100} icon={<UserOutlined />} className="mb-4" />
      ...
      <Card className="shadow-md border-0 text-center py-8">
        ...
        >
          ...
          <Paragraph className="mb-4">
            Congratulations, {character.name}! You've completed all challenges and earned {score}{' '}
            XP!
          </Paragraph>
      ...
      <Card className="shadow-md border-0 mb-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <Avatar src={character.avatar} size={40} icon={<UserOutlined />} className="mr-2" />
            <div>
        ...
        <Progress
          percent={
            (currentLevelIndex * 100 +
              (currentChallengeIndex / currentLevel.challenges.length) * 100) /
            levels.length
          }
          status="active"
          showInfo={false}
      ...
      <Card className="shadow-md border-0">
        <div className="flex items-start mb-4">
          <div className="mr-4 flex-shrink-0">
            <Avatar src={character.avatar} size={60} icon={<UserOutlined />} />
          </div>
          <div>
        ...
        {showHint && (
          <Alert
            message="Hint"
            description={
              currentChallenge.hint || "Try using the functions and concepts you've learned so far."
            }
            type="info"
            showIcon
            icon={<BulbOutlined />}
