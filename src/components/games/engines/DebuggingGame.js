...
import { BugOutlined, CheckCircleFilled, SearchOutlined, BulbOutlined, ThunderboltOutlined } from '@ant-design/icons';
    ...
    return (
      <Card className="shadow-md border-0 text-center py-8">
        ...
        >
          ...
          <Title level={2} className="text-primary mb-4">All Bugs Squashed!</Title>
    ...
    <div className="debugging-game">
      <Card className="shadow-md border-0 mb-4">
        <div className="flex justify-between items-center">
          <Title level={4} className="mb-0">Bug Hunter Mission {currentMission + 1}/{missions.length}</Title>
          <Space>
      ...
      <Card className="shadow-md border-0 mb-4">
        <div className="flex items-start">
          ...
          <div>
            ...
            <Paragraph>{mission.description || "Find and fix all bugs in the code below."}</Paragraph>
          </div>
        </div>
      </Card>
      ...
      <Card className="shadow-md border-0">
        ...
        {showHint && (
          <Alert
            message="Debug Hint"
            description={mission.hint || "Look for syntax errors, indentation issues, or logical errors in the code."}
            type="info"
            showIcon
            icon={<BulbOutlined />}
            className="mb-4"
        ...
        <CodeCompiler
          initialCode={code}
          onSuccess={handleMissionComplete}
        />
